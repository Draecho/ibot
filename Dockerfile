...
# Entrypoint runs as root to fix volume ownership, then drops to node user.
...
# Binds to all interfaces (0.0.0.0) so container platforms like Railway
# can route traffic and run health checks.
